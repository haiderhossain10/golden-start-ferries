export default function HeroContent() {
    return (
        <div className="lg:w-11/12 mx-auto">
            <div className="grid grid-cols-1 lg:items-center lg:grid-cols-[400px_1fr_1fr] py-[50px] text-center lg:text-start">
                <ul className="lg:pr-[40px] pb-3 lg:pb-0">
                    <li className="text-[17px] text-white font-normal">
                        Main Departure port:{" "}
                ...
                <ul className="lg:pl-[40px] pt-3 lg:pt-0">
                    <li className="text-[17px] text-white font-normal">
